...
const DEFAULT_FOOTER = {
  logoText: 'TestSite',
  companyDescription:
    'A simple test website showcasing modern web development with clean design and powerful features. Built for developers who value simplicity and performance.',
  ...
  social4Href: '#',
  social5Href: '#',
  // Product Links - removed most to keep minimal
  ...
  // Company Links - only 2 as required
  linkAbout: 'About',
  linkAboutHref: '#hero',
  linkBlog: 'Blog',
  linkBlogHref: '#hero',
  ...
  linkContact: 'Contact',
  linkContactHref: '#hero',
  // Resources Links - empty as required
  linkHelp: 'Help',
  linkHelpHref: '#hero',
  ...
  linkStatus: 'Status',
  linkStatusHref: '#hero',
  // Legal Links - exactly 2 as required
  linkPrivacy: 'Privacy Policy',
  linkPrivacyHref: '/privacy',
  linkTerms: 'Terms of Service',
  linkTermsHref: '/terms',
  linkCookies: 'Cookie Policy',
  linkCookiesHref: '/privacy',
  linkGdpr: 'GDPR',
  linkGdprHref: '/privacy',
  linkSecurity: 'Security',
  linkSecurityHref: '/privacy',
  linkCompliance: 'Compliance',
  linkComplianceHref: '/privacy',
  // Bottom Links
  linkSitemap: 'Sitemap',
  ...
  linkCookieSettingsHref: '/privacy',
  linkSupport: 'Support',
