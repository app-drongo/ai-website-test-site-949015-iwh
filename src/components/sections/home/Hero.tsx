...
const DEFAULT_HERO = {
  ...
  testimonialText:
    'Their technical expertise transformed our legacy system into a modern, scalable platform. Performance improved by 300% and our development velocity doubled.',
  testimonialAuthor: 'Alex Rodriguez',
  testimonialRole: 'CTO at DevScale',
  testimonialRating: 5,
  ...
  statsValue1: '99.9%',
  statsLabel1: 'Uptime SLA',
  statsValue2: '200+',
  statsLabel2: 'Apps Deployed',
  statsValue3: '10M+',
  statsLabel3: 'API Requests/Day',
  announcementText: 'New: Introducing our AI-powered development toolkit',
  announcementLink: '/ai-toolkit',
  showAnnouncement: true,
  showTestimonial: true,
  showStats: true,
  layoutStyle: 'centered' as LayoutStyle,
} as const;
